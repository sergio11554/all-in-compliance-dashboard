...
cp "${BACKEND_DIR}/intune_connector.py" "${TARGET}/intune_connector.py"
cp "${BACKEND_DIR}/intune_sync.py" "${TARGET}/intune_sync.py"
...
cp "${BACKEND_DIR}/INTUNE.md" "${TARGET}/INTUNE.md"
...
cp "${FRONTEND_DIR}/intune.js" "${TARGET}/frontend-current/intune.js"
cp "${FRONTEND_DIR}/intune.css" "${TARGET}/frontend-current/intune.css"
